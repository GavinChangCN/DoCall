 ...
 * Time: 09:16
 */
public class DoCallApplication extends Application {
    private ActivityLifecycleHelper mActivityLifecycleHelper;
    private static DoCallApplication sInstance;
    private boolean mIsLoginned;
    public static boolean sAppIsOpened;

    public static DoCallApplication getInstance() {
        return sInstance;
    }
    ...
    public void onCreate() {
        ...
        FormatStrategy formatStrategy = PrettyFormatStrategy.newBuilder()
                ...
                .tag("通话宝")   // (Optional) Global tag for every log. Default PRETTY_LOGGER
                .build();
