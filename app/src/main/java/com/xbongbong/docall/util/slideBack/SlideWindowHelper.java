package com.xbongbong.docall.util.slideBack;
...
import com.xbongbong.docall.application.DoCallApplication;
 ...
 * Time: 10:02
 */
public class SlideWindowHelper extends Handler {
    protected static final String TAG = "SwipeWindowHelper";
    ...
    public SlideWindowHelper(@NonNull Window window) {
        this(window, true);
    }

    public SlideWindowHelper(@NonNull Window window, boolean isSupportSlideBack) {
    ...
    class ViewManager {
        ...
        private boolean addViewFromPreviousActivity() {
            ...
            DoCallApplication application = (DoCallApplication) mCurrentWindow.getContext().getApplicationContext();
